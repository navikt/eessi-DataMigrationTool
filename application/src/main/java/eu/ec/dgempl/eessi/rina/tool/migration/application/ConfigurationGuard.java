...
public class ConfigurationGuard {
    ...
    public void check() {
        ...
        if (!f.exists() || f.isDirectory()) {
            System.out.println();
            System.out.println("ERROR - Please add the ProcessDefinitionAssignments.json in the specified path.");
            System.out.println("To download the ProcessDefinitionAssignments.json, please check the User Manual.");
            System.out.println();
