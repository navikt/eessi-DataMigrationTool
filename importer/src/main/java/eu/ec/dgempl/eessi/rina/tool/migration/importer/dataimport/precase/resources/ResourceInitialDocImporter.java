...
@Component
@ElasticTypeImporter(type = EElasticType.RESOURCES_INITIALDOC)
public class ResourceInitialDocImporter extends AbstractResourcesImporter {

    @Override
    protected EResourceType type() {
        return EResourceType.initialdoc;
    }
}
