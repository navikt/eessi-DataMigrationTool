...
@Component
@ElasticTypeImporter(type = EElasticType.RESOURCES_LETTERTEMPLATE)
public class ResourceLetterTemplateImporter extends AbstractResourcesImporter {

    @Override
    protected EResourceType type() {
        return EResourceType.letterTemplate;
    }
}
