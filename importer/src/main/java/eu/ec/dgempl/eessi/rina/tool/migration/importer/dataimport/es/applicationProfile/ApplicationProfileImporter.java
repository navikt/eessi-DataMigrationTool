package eu.ec.dgempl.eessi.rina.tool.migration.importer.dataimport.es.applicationProfile;
...
import eu.ec.dgempl.eessi.rina.tool.migration.importer.dataimport.es.applicationProfile._abstract.AbstractApplicationProfileImporter;
...
public class ApplicationProfileImporter extends AbstractApplicationProfileImporter {
    ...
    public void importData() {
        run(this::processApplicationProfile, false);
    }
    ...
    private void processGlobalData(MapHolder doc) {
        try {
            ...
            dataReporter.reportProblem(this.inferElasticType(), this.getId(doc), "Could not import Global Data from application profile");
        }
    }
    ...
    private void processDefaultUserProfileData(MapHolder doc) {
        ...
        try {
            ...
            dataReporter.reportProblem(this.inferElasticType(), this.getId(doc),
    ...
    private void processTenantParams(
        ...
        for (String key : institutionAliasMapping.fields()) {
            ...
            if (value instanceof Map) {
                ...
                tenantParam.setKey(ETenantParam.lookup(paramKeyValue).orElseThrow(EnumEessiRuntimeException::new));
