...
@Component
@ElasticTypeImporter(type = EElasticType.RESOURCES_PROCESS)
public class ResourceProcessImporter extends AbstractResourcesImporter {

    @Override
    protected EResourceType type() {
        return EResourceType.process;
    }
}
