...
@Component
@ElasticTypeImporter(type = EElasticType.RESOURCES_REPORT)
public class ResourceReportImporter extends AbstractResourcesImporter {

    @Override
    protected EResourceType type() {
        return EResourceType.report;
    }
}
