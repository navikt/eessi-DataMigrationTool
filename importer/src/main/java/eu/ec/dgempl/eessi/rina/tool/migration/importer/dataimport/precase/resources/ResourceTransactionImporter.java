...
@Component
@ElasticTypeImporter(type = EElasticType.RESOURCES_TRANSACTION)
public class ResourceTransactionImporter extends AbstractResourcesImporter {

    @Override
    protected EResourceType type() {
        return EResourceType.transaction;
    }
}
