...
/**
 * Tests the creation of DOC_RECEIVE actions for X003
 */
@Transactional
public class ReceiveX003ActionProducerTest extends AbstractBucProcessorTest {

    private static final Logger logger = LoggerFactory.getLogger(ReceiveX003ActionProducerTest.class);
